...
Partial Class Quiz3
    ...
    Private Sub InitializeComponent()
        ...
        Me.RadioButton2.Text = "Land Grid Array"
        ...
        Me.RadioButton4.Text = "Pin Grid Array"
        ...
        Me.Label1.Text = "What kind of CPU socket has the"
        '
        'Button1
        '
        ...
        Me.Label2.Text = "pins on the CPU?"
        '
        'Quiz3
        '
